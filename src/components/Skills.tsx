    ...
    >
      ...
      <div className="">
        ...
        >
          ...
          <p className="text-white leading-relaxed text-lg font-semibold mb-[0.5rem]">
            I work comfortably with JavaScript, TypeScript, and enjoy adding a
            bit of motion with Framer Motion to make interfaces feel alive. I’m
            big on clean code, smooth performance, and making sure everything
            works seamlessly across different devices.
          </p>
          <p className="text-white leading-relaxed text-lg font-semibold mb-[0.5rem]">
            Right now, I’m learning Node.js, Express, and MongoDB to round out
            my skills and grow into a full-stack developer. I enjoy challenging
            myself to learn something new with every project I take on.
          </p>
        </motion.div>
      </div>
      <p className="text-center text-white leading-relaxed text-md font-semibold mb-[0.5rem] text-[1rem]">
        Here are the technologies I most commonly use :{" "}
      </p>
      <div className=" mx-auto p-6 overflow-hidden grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl">
        {skills.map((skill, index) => {
